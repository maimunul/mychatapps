...
public class ChatActivity extends AppCompatActivity {
    ...
    private void sendMessage(){
        ...
        message.put(Constants.KEY_SENDER_ID, preferenceMmanager.getString(Constants.KEY_USER_ID));
        ...
        if (conversionId!= null){
            ...
            conversion.put(Constants.KEY_SENDER_ID, preferenceMmanager.getString(Constants.KEY_USER_ID));
            conversion.put(Constants.KEY_SENDER_NAME, preferenceMmanager.getString(Constants.KEY_NAME));
            conversion.put(Constants.KEY_SENDER_IMAGE,preferenceMmanager.getString(Constants.KEY_IMAGE));
    ...
    // message detect from database and show to user also add recent conversation
